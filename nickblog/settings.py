...
if ENVIRONMENT == 'production':
    SECRET_KEY = 'django-insecure-)7iv8!ca2vec2t72ujfz1s1^nis!e^i4c+z6iuy(@9!-er1etc' # TODO: fix this later 
    DEBUG = False
else:
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'nickblog.context_processors.debug_mode',
            ],
        },
    },
]
...
# Whitenoise = middleware that allows django to serve own static files in production 
